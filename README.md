...
| Project | Description |
|---------|-------------|
| [**Wee**](https://schlunsen.github.io/wee) | IDE for the agentic engineer — run, monitor, and orchestrate AI agent sessions |
| [**Donna**](https://schlunsen.github.io/donna) | Autonomous AI pentesting platform powered by Claude Code agents |
| [**Claude Agent SDK Go**](https://schlunsen.github.io/claude-agent-sdk-go) | Go port of Anthropic's official Python Agent SDK |
| [**Maperick**](https://schlunsen.github.io/maperick) | Show active TCP connections on a TUI world map |
